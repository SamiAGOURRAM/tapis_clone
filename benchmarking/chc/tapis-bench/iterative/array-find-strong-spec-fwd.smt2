...
(assert (forall ((N@0 Int)(array@0 (Array Int Int))(v@0 Int)(idx@0 Int)(i@0 Int)) (=> (and (> |N@0| 0) (= |idx@0| (- 1)) (= |i@0| 0)) (!inv0 |N@0| |array@0| |v@0| |idx@0| |i@0|))))
...
(assert (forall ((N@0 Int)(array@0 (Array Int Int))(v@0 Int)(idx@0 Int)(i@0 Int)) (=> (and (!inv0 |N@0| |array@0| |v@0| |idx@0| |i@0|) (not (< |i@0| |N@0|)) (not (not (= |idx@0| (- 1)))) (not (forall ((k@0 Int)) (=> (and (<= 0 |k@0|) (< |k@0| |N@0|)) (not (= (select |array@0| |k@0|) |v@0|)))))) false)))
